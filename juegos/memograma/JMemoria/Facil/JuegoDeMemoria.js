...
function bloqueartarjeta(){
    for(let i=0;i<=15;i++){
        ...
        tarjetabloqueada.innerHTML=`<img src="JuegoDeMemoria/${numeros[i]}.png">`;
...
function destapar(id){
    ...
    if(tarjetaDestapadas==1){
        ...
        tarjeta1.innerHTML = `<img src="JuegoDeMemoria/${primerResultado}.png">`;
        tarjeta1.disabled = true;
    }else if(tarjetaDestapadas==2){
        tarjeta2=document.getElementById(id);
        segundoResultado=numeros[id];
        tarjeta2.innerHTML=`<img src="JuegoDeMemoria/${segundoResultado}.png">`;
